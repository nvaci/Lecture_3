...
![pathways](image4.png){#id .class width=20% height=20%}

<br/><br/>
Direct effect: a<br/>
Indirect effect: $b*c + e*f$ <br/>
Total effect: $a+(b*c)+(e*f)$
...
If it is exogenous (only predicting), then we can just dummy code this variable (0 and 1)

.center[
<img src="Image5.jpg", width = "50%">
]

---

## Results: categorical predictor 1
